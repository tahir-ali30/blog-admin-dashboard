...
const BlogDetails = () => {
  ...
  useEffect(() => {
    axios.get(`/api/v1/blogs/${id}`).then(res => setData({ blog: res.data.data }));
  }, []);
          ...
          <div className='content-body'>
            {data !== null ? (
              <Row>
                <Col sm='12'>
                  <Card className='mb-3'>
                    <CardImg src={data.blog?.featured_img} className='img-fluid' top />
                    <CardBody>
                      ...
                      <div className='d-flex align-items-center justify-content-between'>
                        <div className='d-flex align-items-center'>
                          ...
                          <Link to={`/pages/blog/edit/${id}`}>Edit</Link>
                        </div>
