...
const CategoryDetails = () => {
  ...
  return (
    <Fragment>
      <Breadcrumbs title='Category Details' data={[{ title: 'Pages' }, { title: 'Category' }, { title: 'Details' }]} />
          ...
          <div className='content-body'>
            {data !== null ? (
              <Row>
                <Col sm='12'>
                  <Card className='mb-3'>
                    <CardImg src={data?.category_img} className='img-fluid' top />
                    <CardBody>
                      <CardTitle tag='h4'>{data.name}</CardTitle>
                      <div className='d-flex'>
                        <Avatar className='me-50' img={data?.blog?.author?.avatar_img} imgHeight='24' imgWidth='24' />
                        <div>
                          <small className='text-muted me-25'>by</small>
                          <small>
                            <a className='text-body' href='/' onClick={e => e.preventDefault()}>
                              {data.blog?.author?.fullName}
                            </a>
                          </small>
                          <span className='text-muted ms-50 me-25'>|</span>
                          <small className='text-muted'>{data?.blog?.createdAt}</small>
                        </div>
                      </div>
                      ...
                      <div className='d-flex align-items-center justify-content-between'>
                        <div className='d-flex align-items-center'>
                          ...
                          <Link to={`/pages/category/edit/${name}`}>Edit</Link>
                        </div>
